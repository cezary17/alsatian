...
def download_snapshot(base_model_id, fine_tuned_model_ids, hf_cache_dir: str,
    ...
    for hf_model_id in hf_model_ids:
        print(f"Downloading snapshot for {base_model_id}, {hf_model_id}, {i}")
...
if __name__ == '__main__':
    ...
    # model_names = [
    #     FACEBOOK_DETR_RESNET_50_DC5,
    #     CONDITIONAL_DETR_RESNET_50,
    #     FACEBOOK_DETR_RESNET_50,
    #     SENSE_TIME_DEFORMABLE_DETR
    # ]
    model_names = [FACEBOOK_DETR_RESNET_50]
    # model_names = [CONDITIONAL_DETR_RESNET_50]
    ...
    for model_name in model_names:
        ...
        if model_name == FACEBOOK_DETR_RESNET_50:
            ...
            snapshots = download_snapshot(model_name, model_ids, hf_caching_dir, 10)
        else:
